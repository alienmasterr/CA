...
input proc
    ...
    ; Реалізація вводу
    mov si, offset charArray ; Завантаження адреси буфера для зберігання введених символів
    mov cx, 10000 ; Кількість символів, яку можна зберігати в буфері
    mov ah, 0Ah ; Функція для введення рядка з клавіатури
    mov dx, si ; Завантаження адреси буфера для зберігання введених символів у DX
    int 21h ; Виклик DOS-функції для введення рядка
    ret
input endp
